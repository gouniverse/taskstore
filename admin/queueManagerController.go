...
// type queueManagerControllerV1 struct{}

// var _ router.HTMLControllerInterface = (*queueManagerControllerV1)(nil)

// // == CONSTRUCTOR =============================================================

// func NewQueueManagerController() *queueManagerControllerV1 {
// 	return &queueManagerControllerV1{}
// }

// func (controller *queueManagerControllerV1) Handler(w http.ResponseWriter, r *http.Request) string {
...
// func (controller *queueManagerControllerV1) page(data queueManagerControllerV1Data) hb.TagInterface {
...
// func (controller *queueManagerControllerV1) tableQueue(data queueManagerControllerV1Data) hb.TagInterface {
// 	table := hb.Table().
...
// func (controller *queueManagerControllerV1) sortableColumnLabel(data queueManagerControllerV1Data, tableLabel string, columnName string) hb.TagInterface {
...
// func (controller *queueManagerControllerV1) sortingIndicator(columnName string, sortByColumnName string, sortOrder string) hb.TagInterface {
...
// func (controller *queueManagerControllerV1) tableFilter(data queueManagerControllerV1Data) hb.TagInterface {
...
// func (controller *queueManagerControllerV1) tablePagination(data queueManagerControllerV1Data, count int, page int, perPage int) hb.TagInterface {
...
// func (controller *queueManagerControllerV1) prepareData(r *http.Request) (data queueManagerControllerV1Data, errorMessage string) {
// 	var err error
// 	data.request = r
...
// 	if err != nil {
// 		config.LogStore.ErrorWithContext("At queueManagerControllerV1 > prepareData", err.Error())
...
// func (controller *queueManagerControllerV1) fetchQueueList(data queueManagerControllerV1Data) ([]taskstore.Task, []taskstore.Queue, int64, error) {
// 	// userIDs := []string{}
...
// type queueManagerControllerV1Data struct {
